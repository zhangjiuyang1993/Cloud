...
<body>
<form id="findForm" class="form-inline definewidth m20"  action="<%=basePath%>dockerManage/dockerListByNameAndUserId?userid=${userid}" method="post">
	docker编号：
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户ID：
    <input type="text" name="userid" id="uid" value="${userid }" class="abc input-default" placeholder="" readonly="readonly">&nbsp;&nbsp; 
	用户名：
    <input type="text" name="username" id="uname" value="${username }" class="abc input-default" placeholder="" readonly="readonly">&nbsp;&nbsp;
</form>
